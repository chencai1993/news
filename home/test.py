...
# Feel free to rename the models, but don'news rename db_table values or field names.
...
class CrawlData(models.Model):
    ...
    is_agriculture = models.IntegerField(blank=True, null=True)
...
class CrawlDataCopy(models.Model):
    content = models.CharField(max_length=255, blank=True, null=True)
    crawl_time = models.DateTimeField(blank=True, null=True)
    emotion = models.IntegerField(blank=True, null=True)
    keywords = models.CharField(max_length=255, blank=True, null=True)
...
class HomeCrawldata(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'home_crawldata'


class HomeCrawmodel(models.Model):
    crawl_start_url = models.CharField(max_length=255, blank=True, null=True)
    ...
    crawl_max_page = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'home_crawmodel'


class HomeProductnametocate(models.Model):
    keyname = models.CharField(max_length=255, blank=True, null=True)
    product_name = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'home_productnametocate'
